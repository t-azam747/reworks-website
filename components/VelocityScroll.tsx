...
function ScrollVelocityRowImpl({
  ...
  return (
    ...
    >
      <motion.div
        className="inline-flex transform-gpu items-center will-change-transform select-none gap-8 pr-8"
        style={{ x }}
      >
...
// Implement the actual section here:
export function VelocityScrollSection() {
  return (
    <section className="relative w-full bg-[#111111] py-6 md:py-8 overflow-hidden border-y border-white/5">
      <ScrollVelocityContainer className="flex flex-col gap-2 md:gap-3">
